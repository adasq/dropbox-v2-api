...
The `dropbox-v2-api` package interface is generated programmatically, based on [Dropbox endpoints description JSON file][api.json] which is a mirror of Dropbox API HTTP endpoints description, retrived from [official documentaion webpage][docs].
